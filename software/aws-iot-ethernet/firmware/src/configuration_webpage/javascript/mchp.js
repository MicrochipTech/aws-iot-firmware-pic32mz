...
function joinNetwork() {
	...
	var remoteServer;
	remoteServer = document.getElementById('remote_server1').value;
	...
	{
		alert('Please enter a valid URL (e.g. https://123.123.123.123 or https://yourdomain.com.');
		return;
	}

	document.getElementById("rs").value = remoteServer;
	document.getElementById("cc").value = cert;
	document.getElementById("ck").value = key;
