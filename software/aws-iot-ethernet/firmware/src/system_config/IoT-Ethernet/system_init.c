...
char hostNameTest[11] = "xxxxxx_ECM\0";

SYS_MODULE_OBJ TCPIP_STACK_Init()
{
    TCPIP_STACK_INIT    tcpipInit;
    
    //Modifying the host name real time to include unique mac address, may cause issues with stack
    sprintf((char *)&hostNameTest, "%02X%02X%02X_IoT-E", EMAC1SA1bits.STNADDR4, EMAC1SA0bits.STNADDR5, EMAC1SA0bits.STNADDR6);
    TCPIP_HOSTS_CONFIGURATION[0].hostName = hostNameTest;
